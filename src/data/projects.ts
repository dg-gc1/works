...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "An urban research project examining how nighttime street environments influence active travel in Puxi, Shanghai, using remote-sensing imagery, generated street views, and machine learning to identify key environmental thresholds.",
    longDescription:
      "Seeing Night Travel investigates how nighttime street environments influence active travel in Puxi, Shanghai. Combining remote-sensing night-light imagery, generated nighttime street-view scenes, street-level perception analysis, and motion data, the project examines how lighting, density, accessibility, land-use diversity, and perceived safety shape people's willingness to walk or cycle at night. Through XGBoost modelling and SHAP interpretation, the study identifies key environmental factors affecting nighttime active travel — including transport accessibility, land-use diversity, population density, luminance, and building conditions. The project further explores a possible brightness threshold for safer and more comfortable night travel, suggesting how urban streets can support everyday health through environmental design and data-driven planning.",
    type: 'Urban Research',
    year: 2025,
